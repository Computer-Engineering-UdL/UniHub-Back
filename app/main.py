...
app.include_router(members.router, prefix=f"{settings.API_VERSION}/channel", tags=["members"])
app.include_router(messages.router, prefix=f"{settings.API_VERSION}/channel", tags=["messages"])
