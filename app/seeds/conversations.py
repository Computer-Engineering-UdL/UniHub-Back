...
def seed_user_conversations(db: Session) -> None:
    ...
    for i in range(num_conversations):
        ...
        messages_content = [
            ...
            (
                student,
                f"Yes, definitely! I'm a student at the {student.faculty}. When would be a good time to see it?",
            ),
    ...
    for _ in range(num_student_convos):
        ...
        messages_content = [
            (
                student1,
                (
                    f"Hey {student2.first_name}, I saw we're both at {student1.faculty}. "
