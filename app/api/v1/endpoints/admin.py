...
def reset_db(redis: Redis = Depends(get_redis), _: ChannelMember = Depends(require_role(Role.ADMIN))):
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail="Failed to reset database")
